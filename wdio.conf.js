...
exports.config = {
    ...
    capabilities: [{
        ...
        maxInstances: config[testEnv].maxInstance,
        //
        browserName: config[testEnv].browserName,
    ...
    logLevel: config[testEnv].logLevel,
    //
    ...
    waitforTimeout: config[testEnv].timeout,
    //
     ...
     before: function (capabilities, specs) {
         ...
         browser.addCommand('waitAndTypeText', function(selector, text) {
             try {
                ...
                throw new Error(`----Could not enter text on selector: ${selector}`)
             }
         })
     },*/
    /**
    ...
    afterStep: function (test, context, { error, result, duration, passed, retries }) {
        if (error) {
            var date = Date.now();
            var fileName = './allure-results/' + 'screen_' + date + '.png';
